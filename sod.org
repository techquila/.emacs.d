...
:END:" "Template for org-contacts.")
  ...
  (org-capture-templates
   ...
   '(("d" "Documentation" entry (file+headline "~/Dropbox/capture/docs.org" "Documentation")
          ...
          %i\n
          Added %U")
     ("e" "Expense" entry (file+datetree "~/Dropbox/capture/ledger.org" "Expenses")
          "* %?\nIncurred on %U\n %i\n %a")
     ("i" "Idea" entry (file+datetree "~/Dropbox/capture/ideas.org" "Ideas")
          "💡 %?\nHad this idea on %U\n  %i\n %a")
     ("J" "Joke" entry (file+headline "~/Dropbox/capture/jokes.org" "Jokes"))
     ("j" "Journal" entry (file+datetree "~/Dropbox/capture/journal.org")
          "* %?\nEntered on %U\n  %i\n  %a")
     ("k" "Keybinding" entry (file+headline "~/Dropbox/capture/ultimateguide.org"
          "Emacs" "Keybindings"))
     ("l" "Link" entry (file+headline "~/Dropbox/capture/links.org" "Links")
          "%a %^{Link URL} 
          %^{Link Description}
          Added %U")
     ("L" "Lyric" entry (file+headline "~/Dropbox/capture/lyrics.org" 
         "Lyrical Ideas"))
     ("Q" "Quote" entry (file+headline "~/Dropbox/capture/quotes.org" "Quotes"))
     ...
     ("t" "Todo" entry (file+headline "~/Dropbox/capture/todo.org" "Inbox")
         "★ TODO %?\n  %i\n  %a")))
